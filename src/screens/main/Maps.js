    ...
    <View style={styles.container}>
      <ScrollView>
        <View style={styles.buttons}>
          ...
          <TouchableOpacity style={styles.button} onPress={displayTrails}>
            <Text style={styles.buttonText}>Trails</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.button} onPress={displayOther}>
        ...
        <View style={styles.locationContainer}>
          <View style={styles.locationInfo}>
            ...
            <View style={styles.locationInfoAddress}>
              <Text style={styles.locationInfoAddressText}>
                Restaurant · 1611 Rouleau Cres SE
              </Text>
            </View>
          </View>
          <View style={styles.locationButtons}>
