...
export default function StepSeven({ navigation }) {
  const { selectedWeightGoalOption, setSelectedWeightGoalOption } =
    useData(null);
  ...
  return (
    <View style={styles.container} behavior="padding">
      ...
      <View style={styles.mainLabelContainer}>
        <Image
          source={require("../../assets/Setup-pages/target.png")}
      ...
      <View style={styles.inputContainer}>
        ...
        <TouchableOpacity
          style={[
            styles.stayHealthyButton,
            selectedWeightGoalOption === "Maintain current weight"
              ? styles.stayHealthySelected
              : styles.stayHealthyUnselected,
          ]}
          onPress={() => setSelectedWeightGoalOption("Maintain current weight")}
        >
          <Text
            style={[
              styles.stayHealthyText,
