...
export default function StepSix({ navigation }) {
  ...
  const { selectedGoalOption, setSelectedGoalOption } = useData(null);
  ...
  return (
    <KeyboardAvoidingView style={styles.container} behavior="padding">
      ...
      <View style={styles.mainLabelContainer}>
        <Image
          source={require("../../assets/Setup-pages/goal.png")}
      ...
      <View style={styles.inputContainer}>
        <TouchableOpacity
          style={[
            ...
            selectedGoalOption === "gainWeight"
              ? styles.gainWeightSelected
              : styles.gainWeightUnselected,
          ]}
          onPress={() => setSelectedGoalOption("gainWeight")}
        >
          <Text
            style={[
        ...
        <TouchableOpacity
          style={[
            ...
            selectedGoalOption === "loseWeight"
              ? styles.loseWeightSelected
              : styles.loseWeightUnselected,
          ]}
          onPress={() => setSelectedGoalOption("loseWeight")}
        >
          <Text
            style={[
        ...
        <TouchableOpacity
          style={[
            ...
            selectedGoalOption === "stayHealthy"
              ? styles.stayHealthySelected
              : styles.stayHealthyUnselected,
          ]}
          onPress={() => setSelectedGoalOption("stayHealthy")}
        >
          <Text
            style={[
